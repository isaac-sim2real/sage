...
class DualArmStateCollector:
    def __init__(self, arm1_ip, arm2_ip, arm_port, recv_port1, recv_port2):
        ...
        self.arm2_handle = self.arm2.rm_create_robot_arm(self.arm2_ip, self.arm_port)
    ...
    def setup_callbacks(self):
        # Configure arm1
        custom1 = rm_udp_custom_config_t()
        custom1.joint_speed = 0
        custom1.lift_state = 0
        custom1.expand_state = 0
        config1 = rm_realtime_push_config_t(1, True, self.recv_port1, 0, self.arm1_ip, custom1)
        print(self.arm1.rm_set_realtime_push(config1))
        print(self.arm1.rm_get_realtime_push())

        # Configure arm2
        custom2 = rm_udp_custom_config_t()
        custom2.joint_speed = 0
        custom2.lift_state = 0
        custom2.expand_state = 0
        config2 = rm_realtime_push_config_t(1, True, self.recv_port2, 0, self.arm2_ip, custom2)
