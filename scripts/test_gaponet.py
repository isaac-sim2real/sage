...
import torch
import os
from isaaclab.actuators import GapONetActuatorCfg
...
def main():
    ...
    try:
        from isaaclab.actuators import GapONetActuator
    ...
    try:
        ...
        print(f"  - Input shapes: model_obs={model_obs.shape}, branch_obs={branch_obs.shape}, trunk_obs={trunk_obs.shape}")
