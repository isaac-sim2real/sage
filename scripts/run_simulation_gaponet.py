...
def main():
    ...
    parser.add_argument("--original-control-freq", type=int, default=None, help="Original motion data frequency (for resampling, e.g., 30 for AMASS)")
    ...
    parser.add_argument("--enable-realtime", action="store_true", help="Enable realtime sync (slower but matches real time)")
    
    # GapONet arguments
    parser.add_argument("--gaponet-model", type=str, default=None, help="Path to GapONet model (.pt) - required if --use-gaponet")
    ...
    parser.add_argument("--no-use-gaponet", action="store_false", dest="use_gaponet", help="Disable GapONet, use ImplicitActuator (default)")
