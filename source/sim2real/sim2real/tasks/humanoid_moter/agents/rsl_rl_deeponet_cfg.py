...
class DeepONetActorCriticCfg:
    ...
    branch_input_dim: int = 50  # Input dimension for branch network
    branch_hidden_dims: list[int] = [128, 128]  # Hidden dimensions for branch network
    
    # Trunk network configuration
    trunk_input_dim: int = 30  # Input dimension for trunk network
    trunk_hidden_dims: list[int] = [128, 128]  # Hidden dimensions for trunk network
    
    # Output configuration
    action_dim: int = 6  # Dimension of action space
