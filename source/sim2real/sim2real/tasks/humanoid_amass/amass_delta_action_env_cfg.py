...
from sim2real_assets import H1_2_CFG_WITH_HAND_FIX, H1_2_WITH_HAND_FIX_URDF_PATH
...
class HumanoidMotorAmassEnvCfg(DirectRLEnvCfg):
    ...
    * random-start: pose and joint states are set by sampling motion at the start (time zero).
    ...
    motion_file = os.path.join(motion_dir, f"motion_amass/{ROBOT_DICT[robot_name]['motion_dir']}")
